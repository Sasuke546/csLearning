function [ Rsm ] = get_Rsm_cost_svm( C,Q,DS_train,DS_train_label,result_label,model,decision_values,gen_DS )
         ...
         for j = 1:K
             ...
             for s = 1:N
                 if DS_train_label(s,1)==h && result_label(s,1)==j
                     ...
                     Trsm = Trsm + (sqrt(mse) + sqrt(mean(stsm))+A)^2 + kerci;
