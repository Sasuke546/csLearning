function [ c ] = FeatureSel_Multiobj( output_number, DS_train_file, DS_classNumber, Q_value, DS_test_file,ratio,C )

options = gaoptimset('PopulationType', 'bitstring');

n = size(DS_train_file,1)-1;

FitnessFCN = @(bit) LGEM_vector_FeatureSelection_Multiobj(bit,output_number, DS_train_file, DS_classNumber, Q_value, DS_test_file,ratio,C);
